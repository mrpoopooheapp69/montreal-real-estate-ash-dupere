...
function add_my_menus() {
    register_nav_menus(
    array(
        'header-menu' => __( 'Header Menu', 'montreal-real-estate-ash-dupere' ),
        'footer-menu' => __( 'Footer Menu', 'montreal-real-estate-ash-dupere' ),
        'social-menu' => __( 'Social Menu', 'montreal-real-estate-ash-dupere'),
